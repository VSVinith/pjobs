              ...
              {rows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell className="rows-style" align="right">{row.filerName}</TableCell>
                    <TableCell className="rows-style" align="right">{row.filerName}</TableCell>
                    <TableCell className="rows-style" align="right">{row.carbs}</TableCell>
                    <TableCell className="rows-style" align="right">{row.protein}</TableCell>
                  </TableRow>
                );
              })}
              {emptyRows > 0 && (
